...
public static void main(String[] args) {
	...
	List<PracownikL> pracownicy = new LinkedList<>();
	...
	pracownicy.addAll(Arrays.asList(new PracownikL("Jan2", "Kowal2", 31, 2_002), new PracownikL("Jan3", "Kowal3", 33, 2_003)));
	
	for (PracownikL p : pracownicy) {
		suma += p.getSalary();
		sredniWiek += p.getAge();
	}
